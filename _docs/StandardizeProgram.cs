...
// demo of data standardization for neural networks
namespace StandardizeDemo
{
  class StandardizeProgram
  {
    ...
    {
      Console.WriteLine("\nBegin neural network data standardization demo\n");

      string[][] rawData = new string[4][]; // age, sex, income, location -> politics
      rawData[0] = new string[] { "30", "male  ", "38000.00", "urban   ", "democrat  " }; 
      rawData[1] = new string[] { "36", "female", "42000.00", "suburban", "republican" };
      rawData[2] = new string[] { "52", "male  ", "40000.00", "rural   ", "independent" };
      rawData[3] = new string[] { "42", "female", "44000.00", "suburban", "other      " };

      Console.WriteLine("Raw data : \n");
      Helpers.ShowMatrix(rawData, true, true);

      string[] colTypes = new string[] { "numeric", "categorical", "numeric", "categorical", "categorical" };
      ...
      rawData[0] = new string[] { "72", "190", "technology  ", "male  " };
      rawData[1] = new string[] { "70", "160", "construction", "male  " };
      rawData[2] = new string[] { "66", "110", "education   ", "female" };
      rawData[3] = new string[] { "67", "120", "technology  ", "female" };
      ...
      colTypes = new string[] { "numeric", "numeric", "categorical", "categorical" };
      ...
      rawData[0] = new string[] { "30", "male  ", "urban   ", "democrat   ", "38000.00" };
      rawData[1] = new string[] { "36", "female", "suburban", "republican ", "42000.00" };
      rawData[2] = new string[] { "52", "male  ", "rural   ", "independent", "40000.00" };
      rawData[3] = new string[] { "42", "female", "suburban", "other      ", "44000.00" };
      ...
      colTypes = new string[] { "numeric", "categorical", "categorical", "categorical", "numeric" };
      s = new Standardizer(rawData, colTypes);
      standardData = s.StandardizeAll(rawData);
